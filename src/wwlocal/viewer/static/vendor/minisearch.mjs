// MiniSearch 7.2.0 `dist/es/index.js`, verbatim: BM25 full-text search in one ES module (MIT, Luca Ongaro).
// Bump: `npm pack minisearch@<ver>`, then copy package/dist/es/index.js over this file, keeping this header.
/** @ignore */
